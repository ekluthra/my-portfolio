...
import { useParams } from "react-router-dom"; //takes out sections of url we need and use accordinly
                    ...
                    <div className="absolute h-full w-full flex items-center justify-center p-8">
                        <div className="bg-green-100 bg-opacity-90 rounded p-12">
                            ...
                            <div className="flex justify-center text-gray-800">
                                ...
                                alt={singlePost.name}
                                className="w-10 h-10 rounded h-full"
                                />
                                <p className="navfont flex items-center pl-2 text-2xl">{singlePost.name}</p>
                            </div>
                        </div>
                    </div>
                    <img 
